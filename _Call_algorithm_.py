...
hiddvar          = np.array(["U1","U2"])                       # declare an array contining the hidden variables
...
hiddvar2          = np.array(["U1","U2","U3","U4"])             # declare an array contining the hidden variables
...
hiddvar3          = np.array(["U1","U2","U3","U4"])             # declare an array contining the hidden variables
